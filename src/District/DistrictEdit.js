...
const DistrictEdit = (props) => {
    ...
    const getData = () => {
        ...
        setPending(true);
        fetch(`${baseURL}/district/${props.match.params.slug}`, {
            method: "GET",
            headers: { "Authorization": `Bearer ${token}` }
        }).then(res => res.json()).then(json => {
            formValues.districtid = props.match.params.slug;
            formValues.stateid = json.stateid;
            formValues.districtname = json.districtname;
        ...
        <div className='container-fluid my-4'>
            <div className="card mt-3">
                <div className="card-header">
                    <div className='row'>
                        <div className='col-10'>EDIT DISTRICT</div>
                        <div className='col-2'>
